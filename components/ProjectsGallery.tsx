...
export default function ProjectsGallery() {
    ...
    return (
        <section ref={sectionRef} id="work" className="relative">
            ...
            <div
                ref={trackRef}
                className="flex gap-[2vw] px-8 md:px-16 pb-32 pt-8"
                style={{ width: "max-content" }}
            >
                {projects.map((project, index) => (
                    <div
                        key={project.id}
                        className="project-card group w-[75vw] md:w-[40vw] h-[55vh] md:h-[65vh] rounded-xl overflow-hidden relative flex-shrink-0"
